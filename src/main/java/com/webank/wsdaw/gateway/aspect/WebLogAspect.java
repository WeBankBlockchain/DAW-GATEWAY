package com.webank.wsdaw.gateway.aspect;

import cn.hutool.json.JSONUtil;
import com.webank.wsdaw.gateway.enums.CodeEnum;
import com.webank.wsdaw.gateway.monitor.MonitorEntry;
import com.webank.wsdaw.gateway.monitor.MonitorUtil;
...
public class WebLogAspect {
    ...
    @Around("execution(* com.webank.wsdaw.gateway.controller.*.*(..))")
    public Object logAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        log.info("Request http remote IP is [{}]", ipAddress);
        try {
    ...
    @AfterReturning(
            pointcut = "execution(* com.webank.wsdaw.gateway.controller.*.*(..))",
            returning = "result")
